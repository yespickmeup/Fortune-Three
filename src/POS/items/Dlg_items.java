...
//                        e.consume();
    ...
    public static class TblitemsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "QTY", "BARCODE", "DESCRIPTION", "generic_name", "CATEGORY", "category_id", "CLASSIFICATION", "classification_id", "SUPPLIER"
    ...
    private void data_cols() {
        ...
        loadData_items(Items.ret_data(search, category, classification, sub_class, supplier));
    }
    ...
    private void add_items() {
        ...
        to_items to = new to_items(id, barcode, description, generic_name, category, category_id
                ...
                , user_name, item_type, status, supplier, fixed_price, cost, supplier_id, multi_level_pricing, new ArrayList(), vatable,reorder_level);
...
//                convertRowIndexToModel(row));
        ...
        to_items to1 = new to_items(id, barcode, description, generic_name, category, category_id, classification, classification_id
                ...
                , item_type, status, supplier, fixed_price, cost, supplier_id, multi_level_pricing, new ArrayList(), vatable,reorder_level);
        Items.edit_items(to1, code);
        data_cols();
        clear_items();
        btn_edit.setEnabled(true);
        btn_delete.setEnabled(true);
