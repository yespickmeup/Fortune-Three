...
import POS.util.FullScreen;
import POS.util.Wallpaper;
...
//        Center.setCenter(frame);
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            System.setProperty("img_path", prop.getProperty("img_path", userHome));
            
            System.setProperty("mydb", prop.getProperty("mydb", "db_fortune_three"));
            String mydb = System.getProperty("mydb", "db_fortune_three");
            MyDB.setNames(mydb);
