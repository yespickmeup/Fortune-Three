...
//        jPanel2.set
    ...
    private void set_cashier() {
        cb_cashier.setModel(new ListComboBoxModel(Users.
...
//                btn_0.doClick();
    ...
    private void get_data() {
        ...
        String cashier_name = cb_cashier.getSelectedItem().
                toString();
        Users.to_users to = Users.ret_data_w_screen_name(cashier_name);
        if (to == null) {
            cashier_name = "";
        } else {
...
//                        return TextHighlighter1.highlight("VOID", "VOID", "RED");
    ...
    private void reprint() {
        ...
        for (S1_sales_items.to_sales_items to1 : datas) {
            ...
            Srpt_receipt.field tbar = new Srpt_receipt.field(to1.description + add, new Date(), to1.selling_price*to1.product_qty
                    , to1.product_qty, to1.selling_price);
            fields.add(tbar);
        }
        String business_name = System.getProperty("business_name", "Fortune Tree Enterprises");
