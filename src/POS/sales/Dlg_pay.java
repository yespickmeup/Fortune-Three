...
//</editor-fold>
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tf_customer, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void focus() {
        JTextField[] tf = {tf_service_amount, tf_services, tf_discount, tf_name, tf_id_no, tf_customer, tf_check_bank, tf_check_amount, tf_check_holder, tf_check_no, tf_amount_paid, lbl_discount_amount};
        Focus_Fire.onFocus_lostFocus(tf);
    }

    private void init_tf() {
        final SearchField sf = (SearchField) tf_customer;
        sf.setFont(new java.awt.Font("Tahoma", 1, 14));
        sf.set_instruction1("Search Customers");
        sf.set_searcher(new SearchField.ISearcher() {

            @Override
            public List get_entered(String starts_with) {
                return S1_customers.ret_cb_data();
            }
        });
...
//            System.out.println(discount_customer_name + " ----- ");
            ...
            S1_sales.to_sales to = new S1_sales.to_sales(id, sales_no, date_added, user_name, session_no, gross_amount, amount_paid, amount_due, discount_name, discount, discount_amount, customer, check_bank, check_no, check_amount, discount_customer_name, discount_customer_id, status, or_no, check_holder, serv, service_amount);
    ...
    private void add_customer() {
        SearchField sf = (SearchField) tf_customer;
        List<String> aw = sf.possibilities;
        String type = tf_customer.getText();
        int naa = 0;
        for (String s : aw) {
        ...
        if (naa == 0) {
            if (!sf.getText().
                    isEmpty()) {
                 S1_customers.to_customers to = new S1_customers.to_customers(-1, type);
